        ...
        <div className="row d-flex justify-content-center suscribe-container">
            <div className="col-12 col-sm-12 col-md-12 col-lg-6 form-wrapper">
                ...
                <div className="row d-flex justify-content-center">
                    <div className="col-5 col-sm-5 col-md-3 col-lg-4">
                ...
                {props.showForm ?
                    ...
                    <div className="row title-wrapper">
                        <div className="col-12 col-sm-12 col-md-12 col-lg-12 text-left">
                            <a href="javascript:void(0)" onClick={props.goBack}>Click to Go back and suscribe again - Hint: Try to suscribe with the same email! ;)</a>
                        </div>
                    </div>
                }
